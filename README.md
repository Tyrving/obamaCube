...
Keybinds:
W, A, S, D, C, Spacebar move the cube in 3 linear axes. 
Mouse moves x/y rotation, Q and E move z rotation. 
1, 2, 3 Keys change the cube texture/image. 

If someone wants linux executables, let me know. I will NOT be producing a 32-bit windows executable. 32-bit needs to die.
Please enjoy obama cube simulator.
